...
- In-console Account settings (PostgreSQL Link & MCP API Keys integrated)
...
# ---------------------------------------------------------------------------
# Form Handlers for In-Console Database & API Key Actions
# ---------------------------------------------------------------------------
...
async def create_api_key(request: Request):
    ...
    await db_control.create_api_key(pool, user_id, security.hash_api_key(raw_key), "Console Key")
